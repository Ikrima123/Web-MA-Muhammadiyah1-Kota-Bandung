...
if (isset($_POST['tambah'])) {
    ...
    $query = "INSERT INTO tbl_news (judul, deskripsi, foto) VALUES ('$judul', '$deskripsi', '$gambar_path')";
...
if (isset($_POST['edit'])) {
    ...
    if ($_FILES['gambar']['name'] != '') {
        ...
        $old_image_path_query = "SELECT foto FROM tbl_news WHERE id = $berita_id";
        ...
        $gambar_path_query = "SELECT foto FROM tbl_news WHERE id = $berita_id";
    ...
    $query = "UPDATE tbl_news SET judul='$judul', deskripsi='$deskripsi', foto='$gambar_path' WHERE id=$berita_id";
    $result = mysqli_query($conn, $query);
...
if (isset($_GET['hapus_id'])) {
    $berita_id = $_GET['hapus_id'];

    $image_path_query = "SELECT foto FROM tbl_news WHERE id = $berita_id";
    ...
    $delete_query = "DELETE FROM tbl_news WHERE id=$berita_id";
