...
<body>
 ...
 <header>
   ...
   <!-- Form untuk menambah atau mengedit berita -->
<form action="proses_prestasi.php" method="post" enctype="multipart/form-data">
    <label for="prestasi">Prestasi:</label>
    <input type="text" name="prestasi" required>
    <br>
    <input type="hidden" name="prestasi_id" value="0">
    <br>
    ...
    <table border="1" cellpadding="5">
        ...
        $query = "SELECT * FROM tbl_prestasi";
        ...
        if ($result) {
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo "<td><a href='proses_prestasi.php?hapus_id={$row['id']}'>Hapus</a> | ";
                echo "</tr>";
            }
        } else {
