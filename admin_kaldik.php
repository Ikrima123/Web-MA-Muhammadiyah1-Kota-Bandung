...
<head>
    ...
    <title>Admin - Kelola Kaldik</title>
...
<body>
 ...
 <header>
    ...
    <h2>Kelola Kalender Pendidikan</h2>

    <!-- Form untuk menambah atau mengedit berita -->
   <!-- Form untuk menambah atau mengedit berita -->
<form action="proses_kaldik.php" method="post" enctype="multipart/form-data">
    <label for="tanggal">Tanggal (TTTT-MM-DD):</label>
    ...
    <br>
    <input type="hidden" name="kaldik_id" value="0">
    <br>
    <!-- Gunakan hidden input untuk menyimpan ID berita yang akan diubah -->

    <button type="submit" name="tambah">Tambah Kaldik</button>
</form>
    ...
    <table border="1" cellpadding="5">
        ...
        if ($result) {
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo "<td><a href='proses_kaldik.php?hapus_id={$row['id']}'>Hapus</a> | ";
                echo "</tr>";
            }
        } else {
