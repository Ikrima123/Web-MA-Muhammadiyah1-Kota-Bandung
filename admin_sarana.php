...
<head>
    ...
    <title>Admin - Kelola Sarana</title>
...
<body>
 ...
 <header>
    ...
    <h2>Kelola Sarana Prasarana</h2>

    <!-- Form untuk menambah atau mengedit berita -->
   <!-- Form untuk menambah atau mengedit berita -->
<form action="proses_sarana.php" method="post" enctype="multipart/form-data">
    ...
    <br>
    <input type="hidden" name="sarana_id" value="0">
    <br>
    <!-- Gunakan hidden input untuk menyimpan ID berita yang akan diubah -->

    <button type="submit" name="tambah">Tambah Sarana</button>
</form>

    <!-- Daftar berita yang sudah ada -->
    
    <h3>Daftar Sarana Prasarana</h3>
    <table border="1" cellpadding="5">
        ...
        if ($result) {
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo "<td><a href='proses_sarana.php?hapus_id={$row['id']}'>Hapus</a> | ";
                echo "</tr>";
            }
        } else {
